...
if ($action === 'delete_user' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    require_once __DIR__ . '/controllers/RegistrarController.php';
    $registrarController = new RegistrarController();
    // delete_user action handled by getDashboardData's delete form earlier; keep backward compatibility
    $registrarController->getDashboardData();
}
...
if ($action === 'answer_question' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    require_once __DIR__ . '/controllers/AdvisorController.php';
    $ctrl = new AdvisorController();
    $ctrl->answerQuestion();
}

if ($action === 'resolve_question' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    require_once __DIR__ . '/controllers/AdvisorController.php';
    $ctrl = new AdvisorController();
    $ctrl->resolveQuestion();
}

// Student actions
if ($action === 'ask_question' && $_SERVER['REQUEST_METHOD'] === 'POST') {
